...
<body>
    ...
    <main class="page landing-page" style="padding-top: 50px;">
        <section class="clean-block clean-hero" style="background-image: url(&quot;assets/img/39033.png?h=a7c7e994ab090fca31faa4c55ebbfee1&quot;);color: rgba(9,211,255,0.85);">
            <div class="text" style="width: auto;">
                <h2>Pencarian Anime</h2>
                <p></p>
                <form action="anime.php" method="get"><input class="form-control form-control-lg" type="text" id="title" name="title" placeholder="Ketikan Judul Disini" autofocus="" style="width: auto;"><button class="btn btn-primary btn-lg" type="submit" style="margin-top: 20px;">Cari</button></form>
            </div>
        </section>
    </main>
